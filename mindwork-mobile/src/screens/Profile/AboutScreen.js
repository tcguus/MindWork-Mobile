...
export default function AboutScreen() {
  // Coloque aqui os nomes reais do seu grupo
  const developers = [
    { name: 'Seu Nome 1', rm: 'RM12345' },
    { name: 'Seu Nome 2', rm: 'RM67890' },
    { name: 'Seu Nome 3', rm: 'RM11223' },
    { name: 'Seu Nome 4', rm: 'RM44556' },
  ];

  const handleOpenLink = () => {
    Linking.openURL('https://github.com/tcguus/MindWork-API');
  };
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.infoContainer}>
        ...
        {/* Você pode pegar os 7 primeiros dígitos do seu último commit git log */}
